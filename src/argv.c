...
int				g_flags[] = {
	...
	'l', FLAG_L, FLAG_1,
	'F', FLAG_FF, 0,
	't', FLAG_T, FLAG_UU | FLAG_U | FLAG_SS | FLAG_C,
	'g', FLAG_G, FLAG_1,
	'o', FLAG_O, FLAG_1,
	'R', FLAG_RR, 0,
	'u', FLAG_U, FLAG_SS | FLAG_UU | FLAG_T | FLAG_C,
	'U', FLAG_UU, FLAG_SS | FLAG_U | FLAG_T | FLAG_C,
	'n', FLAG_N, 0,
	'd', FLAG_D, 0,
	'S', FLAG_SS, FLAG_UU | FLAG_U | FLAG_T | FLAG_C,
	'c', FLAG_C, FLAG_SS | FLAG_UU | FLAG_U | FLAG_T,
	'p', FLAG_P, 0,
	0
};
